                ...
                <div class="col-sm-6">
                    <div class="social-icons pull-right">
                        <ul class="nav navbar-nav">
                            ...
                            <li><a href="{{ getConfigValueFromSettingTable('dribbble_link') }}"><i class="fa fa-dribbble"></i></a></li>
                            <li><a href="{{ getConfigValueFromSettingTable('googleplus_link') }}"><i class="fa fa-google-plus"></i></a></li>
                        </ul>
                    </div>
                </div>
            </div>
